...
## Active Worktree: local-whisper-design
Scope: Design doc for running Whisper locally on a self-hosted VM.
Other parallel branches: concise-prompting, selective-tts, prompt-caching, google-cloud-tts, smart-model-routing, local-tts-design, cost-monitoring
