...
## Active Worktree: cost-monitoring
Scope: Per-interaction cost tracking, /stats tRPC endpoint, console logging.
Other parallel branches: concise-prompting, selective-tts, prompt-caching, google-cloud-tts, smart-model-routing, local-whisper-design, local-tts-design
